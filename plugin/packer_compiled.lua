...
_G.packer_plugins = {
  ...
  ReplaceWithRegister = {
    loaded = true,
    path = "/home/kevin/.local/share/nvim/site/pack/packer/start/ReplaceWithRegister",
  ...
  ["copilot.vim"] = {
    loaded = true,
    path = "/home/kevin/.local/share/nvim/site/pack/packer/start/copilot.vim",
  ...
  ["git-messenger.vim"] = {
    loaded = true,
    path = "/home/kevin/.local/share/nvim/site/pack/packer/start/git-messenger.vim",
  ...
  ["mason-null-ls.nvim"] = {
    loaded = true,
    path = "/home/kevin/.local/share/nvim/site/pack/packer/start/mason-null-ls.nvim",
  ...
  ["typescript.nvim"] = {
    loaded = true,
    path = "/home/kevin/.local/share/nvim/site/pack/packer/start/typescript.nvim",
    url = "https://github.com/jose-elias-alvarez/typescript.nvim"
  },
  ["vim-maximizer"] = {
    loaded = true,
    path = "/home/kevin/.local/share/nvim/site/pack/packer/start/vim-maximizer",
  ...
  ["vim-tmux-navigator"] = {
    loaded = true,
    path = "/home/kevin/.local/share/nvim/site/pack/packer/start/vim-tmux-navigator",
